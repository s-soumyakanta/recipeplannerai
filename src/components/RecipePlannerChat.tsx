...
const RecipePlannerChat: React.FC = () => {
  ...
  return (
    <div className="flex rounded-md flex-col h-full md:h-[97%]  overflow-hidden">
      {!isChatStarted ? (
          ...
          <div className="flex-grow flex flex-col justify-between">
            <div className="max-w-4xl mx-auto w-full flex flex-col h-full justify-between">
              <div className="text-center">
                <div className="mb-6 inline-block p-4 bg-blue-700 dark:bg-blue-800 rounded-full">
                  <GiCook className="text-5xl sm:text-6xl text-white " />
                </div>
                <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4 ">Welcome to RecipePlannerAI</h1>
                <p className="text-base lg:text-lg mb-4 max-w-2xl mx-auto  ">
              ...
              <div className="grid md:grid-cols-2 gap-6 sm:gap-8">
                <div className="bg-gray-100 dark:bg-gray-900 rounded-2xl shadow-xl p-6 flex flex-col items-center text-center transition duration-300 hover:shadow-2xl transform hover:-translate-y-1 w-full">
                  <GiMeal className="text-4xl sm:text-5xl mb-4 text-blue-700 dark:text-blue-500 " />
                  ...
                  <Link href="/dashboard/available-ingredients" 
                    className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-6 rounded-full transition duration-300 text-sm sm:text-base transform hover:scale-105 shadow-md hover:shadow-lg">
                    Set Available Ingredients
                  </Link>
                </div>
                
                <div className="bg-gray-100 dark:bg-gray-900 rounded-2xl shadow-xl p-6 flex flex-col items-center text-center transition duration-300 hover:shadow-2xl transform hover:-translate-y-1 w-full">
                  <GiWeightScale className="text-4xl sm:text-5xl mb-4 text-blue-700 dark:text-blue-500 " />
